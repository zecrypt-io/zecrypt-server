...
export default function PrivacyPage() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <p className="mb-8"><strong>Effective Date:</strong> March 19, 2024</p>

      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">1. Zero-Knowledge Architecture</h2>
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">3. Data Encryption</h2>
        <p className="text-gray-600">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">4. Your Control</h2>
        <p className="text-gray-600">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">5. Device Security</h2>
        <p className="text-gray-600">
      ...
      <section className="mb-8">
        <h2 className="text-2xl font-semibold text-gray-800 mb-4">7. Policy Updates</h2>
        <p className="text-gray-600">
