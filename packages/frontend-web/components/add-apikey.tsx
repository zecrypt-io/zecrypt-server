...
export function AddApiKey({ onClose, onApiKeyAdded }: AddApiKeyProps) {
  ...
  const predefinedTags = ["read", "write", "delete", "admin", "public"];
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Placeholder for encryption (backend generates the key)
      const dataToEncrypt = "";
      ...
      const payload = {
        ...
        data: { hash: "", encryptedKey: encryptedData }, // Backend will overwrite
      };
