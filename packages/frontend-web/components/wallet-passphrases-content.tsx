...
import { Wallet, Plus, Pencil, Trash2, Eye, EyeOff, Copy, Check, Search, X } from "lucide-react"
          ...
          <Table>
            ...
            <TableBody>
              {filteredPassphrases.map((passphrase) => (
                <TableRow key={passphrase.id}>
                  <TableCell className="font-medium">{passphrase.name}</TableCell>
                  <TableCell>{passphrase.walletType}</TableCell>
                  <TableCell>
                  ...
                  <TableCell>{formatDate(passphrase.createdAt)}</TableCell>
                  <TableCell>{formatDate(passphrase.lastAccessed)}</TableCell>
