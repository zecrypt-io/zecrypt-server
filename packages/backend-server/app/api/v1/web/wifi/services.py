...
def get_wifi_details(db, doc_id):
    return response_helper(
        status_code=200,
        message="Wifi details loaded successfully",
...
def add_wifi(request, user, payload, background_tasks):
    ...
    if wifi:
        return response_helper(status_code=400, message="Wifi details with same title already exists")
...
def update_wifi(request, user, payload, background_tasks):
    ...
    return response_helper(status_code=200, message="Wifi details updated successfully",)
...
def delete_wifi(request, user, background_tasks):
    ...
    return response_helper(status_code=200, message="Wifi details deleted successfully", data={},)
