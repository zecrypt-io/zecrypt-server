...
from app.api.v1.web.user.services import (get_favorite_tags, update_favorite_tags,get_profile,get_login_history)
from app.api.v1.web.user.schema import AddFavoriteTags
...
async def update_favorite_tags_api(
    request: Request, payload: AddFavoriteTags, user: UserDetails = Depends(get_current_user)
):
