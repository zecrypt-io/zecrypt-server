...
def add_card(request, user, payload, background_tasks):
    ...
    if card:
        return response_helper(status_code=400, message="Card details with same title already exists")
...
def update_card(request, user, payload, background_tasks):
    ...
    return response_helper(status_code=200, message="Card details updated successfully",)
...
def delete_card(request, user, background_tasks):
    ...
    return response_helper(status_code=200, message="Card details deleted successfully", data={},)
